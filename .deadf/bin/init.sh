...
usage() {
    cat <<'USAGE'
Usage: init.sh [--project <dir>] [--dry-run]
...
DETECT_SCRIPT="$SCRIPT_DIR/init-detect.sh"
MAP_SCRIPT="$SCRIPT_DIR/init-map.sh"
CONFIRM_SCRIPT="$SCRIPT_DIR/init-confirm.sh"
P2_SCRIPT="$SCRIPT_DIR/brainstorm.sh"
